...
import { formatRelativeTime, emojiForEventType, labelForEventType } from '@/lib/time'
      ...
      <div className="space-y-1 max-h-64 overflow-y-auto">
        {events.length === 0 ? (
          ...
          events.map((event) => (
            ...
            >
              <span className="text-base flex-shrink-0 mt-0.5">{emojiForEventType(event.type)}</span>
